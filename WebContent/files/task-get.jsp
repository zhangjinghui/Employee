				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<s:if test="empno == null">任务信息查看</s:if>
							...
							<div class="row">
								...
								<s:form action="task-save" method="post" theme="simple"
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											<label>优先级</label>
											<s:textfield name="priority" class="form-control"
												readonly="true" />
										</div>
										<div class="form-group">
											<label>任务执行部门</label>
											<s:textfield name="department.dname" class="form-control"
												readonly="true" />
										</div>
									</div>
									<div class="row">
										<div class="col-lg-6">
											...
											<div class="form-group">
												...
												<td colspan="3"><s:textarea id="textarea"
														name="content" rows="5" cols="80" readonly="true"></s:textarea></td>
											</div>
