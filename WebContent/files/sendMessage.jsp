			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">个人信息查看</div>
						<!-- /.panel-heading -->
						<div class="panel-body">
							<div class="table-responsive">
								<s:form action="message-sendMessage" method="post" theme="simple">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<td width="31%" height="35" class="login-text02">发送者：<br /></td>
						<td width="69%">${session.user.username }</td>
					 <tr>					 
						<td width="31%" height="35" class="login-text02">接收者：<br /></td>
						<td><select name="receiver">
                		<s:iterator value="receiverList" var="vs">
                		<option value="${vs}">${vs}</option>		
                		</s:iterator> 
						</tr> 
						<tr>
							<td width="31%" height="35" class="login-text02">标题：<br /></td>
							<td width="69%"><s:textfield name="message.title" size="30"
									required="true"></s:textfield></td>
						</tr>
						<tr>
							<td width="31%" height="35" class="login-text02">内容：<br /></td>
							<td width="69%"><s:textarea name="message.content" size="6"
								class="form-control"	required="true"></s:textarea></td>
						</tr>						
						<tr>
							<td height="35">&nbsp;</td>
							<td><s:submit name="Submit2" value="发送"
									class="right-button01"></s:submit></td>
						</tr>
					</table>
				</s:form>
							</div>
