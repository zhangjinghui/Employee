...
<script type="text/javascript">
	$(function() {
		...
		$("#sal-input").click(function() {
			location.href = "sal-input";
		});
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">工资明细查看</div>
						<!-- /.panel-heading -->
						<div class="panel-body">

							<div class="table-responsive">
								<form action="sal-list" name="fom" id="fom" method="post">
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
											<s:iterator value="#request.sals">
												<tr>
													<td>${id }</td>
													<td>${year }</td>
													<td>${month }</td>
													<td>${ename }</td>
													<td>${salgrade.basicsalary }</td>
													<td>${bouns }</td>
													<td>${fine }</td>
													<td>${realsalary }</td>
													<td>${sender }</td>
									...
									<table width="100%" border="0" align="center" cellpadding="0"
										...
										<tr>
											...
											<td width="49%" align="right">[<a
												href="sal-list?pageNum=1" class="right-font08">首页</a> | <a
												href="<s:if test="pageNum == 1">#</s:if><s:else>sal-list?pageNum=${pageNum-1 }</s:else>"
												class="right-font08">上一页</a> | <a
												href="<s:if test="pageNum == #request.maxPage">#</s:if><s:else>sal-list?pageNum=${pageNum+1 }</s:else>"
												class="right-font08">下一页</a> | <a
												href="sal-list?pageNum=${maxPage }" class="right-font08">末页</a>]
												转至：
											</td>
											<td width="1%">
