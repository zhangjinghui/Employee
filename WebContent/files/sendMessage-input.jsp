				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<s:if test="id == null">客户信息添加</s:if>
							<s:else>客户信息编辑</s:else>
						</div>
						<!-- /.panel-heading -->
						<div class="panel-body">
							<div class="row">

								<s:form action="customer-save" method="post" theme="simple"
									role="form">
									<div class="col-lg-6">
										<s:hidden name="id"></s:hidden>
										<div class="form-group">
											<label>公司名称</label>
											<s:textfield name="companyname" class="form-control"
												required="true"></s:textfield>
										</div>
										<div class="form-group">
											<label>联系人</label>
											<td><s:textfield name="contact" class="form-control"
													required="true"></s:textfield>
										</div>

										<div class="form-group">
											<label>公司简介</label>
											<s:textarea name="briefintroduction" class="form-control"
												required="true" style="height:133px;resize:none"></s:textarea>
										</div>
									</div>
									<div class="row">
										<div class="col-lg-6">
											<div class="form-group">
												<label>联系电话</label>
												<s:textfield name="phone" class="form-control"
													required="true"></s:textfield>
												<span style="color: red">${fieldErrors.phone[0] }</span>
											</div>
											<div class="form-group">
												<label>联系地址</label>
