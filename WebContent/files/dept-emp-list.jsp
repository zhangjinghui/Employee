...
<script type="text/javascript">
	$(function() {
		...
		$("#emp-input").click(function() {
			location.href = "emp-input";
		});
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">员工信息查看</div>
						<!-- /.panel-heading -->
						<div class="panel-body">

							<div class="table-responsive">
								<form action="dept-getEmployee?deptno=${deptno }" name="fom" id="fom" method="post">
										...
										<tbody>
											<s:iterator value="#request.employees">
												<tr>
													...
													<td>${ename }</td>
													<td>${job }</td>
													<td><s:date name="hiredate" format="yyyy-MM-dd" /></td>
													<td><s:date name="createtime"
															format="yyyy-MM-dd hh:mm:ss" /></td>
													<td>${department.dname }</td>
													<td><a href="emp-input?empno=${empno }">编辑</a>&nbsp;|&nbsp;<a
														class="delete" href="emp-delete?empno=${empno }">删除</a>&nbsp;|&nbsp;<a
														href="sal-input?empno=${empno}">发工资</a></a>&nbsp;|&nbsp;<a
									...
									<table width="100%" border="0" align="center" cellpadding="0"
										...
										<td width="49%" align="right">[<a
											href="dept-getEmployee?deptno=${deptno }&pageNum=1"
											class="right-font08">首页</a> | <a
											href="<s:if test="pageNum == 1">#</s:if><s:else>dept-getEmployee?deptno=${deptno }&pageNum=${pageNum-1 }</s:else>"
											class="right-font08">上一页</a> | <a
											href="<s:if test="pageNum == #request.maxPage">#</s:if><s:else>dept-getEmployee?deptno=${deptno }&pageNum=${pageNum+1 }</s:else>"
											class="right-font08">下一页</a> | <a
											href="dept-getEmployee?deptno=${deptno }&pageNum=${maxPage }"
									...
									<input name="Submit" id="emp-input" type="button"
										class="btn btn-outline btn-success" value="添加员工信息" />
								</form>
							</div>
						</div>
					</div>
