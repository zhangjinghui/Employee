...
<script type="text/javascript">
	$(function() {
		...
		$("#salgrade-input").click(function() {
			location.href = "salgrade-input";
		});
		...
		$(".delete").click(function() {
			...
			if (flag) {
				var flag = confirm("注意：删除操作会同时删除该职位的所有员工，确定要删除吗？");
			}
			if (flag) {
				// 删除，使用 ajax 的方式
				var url = this.href;
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">薪资类型查看</div>
						<!-- /.panel-heading -->
						<div class="panel-body">

							<div class="table-responsive">
								<form action="salgrade-list" name="fom" id="fom" method="post">
										...
										<tbody>
											<s:iterator value="#request.grades">
												<tr>
													...
													<td><s:date name="edittime"
															format="yyyy-MM-dd hh:mm:ss" /></td>
													<td><a href="salgrade-input?id=${id }">编辑</a>&nbsp;|&nbsp;<a
														class="delete" href="salgrade-delete?id=${id }">删除</a></td>
												</tr>
											</s:iterator>
										</tbody>
									</table>
									...
									<table width="100%" border="0" align="center" cellpadding="0"
										...
										<tr>
											...
											<td width="49%" align="right">[<a
												href="salgrade-list?pageNum=1" class="right-font08">首页</a> |
												<a
												href="<s:if test="pageNum == 1">#</s:if><s:else>salgrade-list?pageNum=${pageNum-1 }</s:else>"
												class="right-font08">上一页</a> | <a
												href="<s:if test="pageNum == #request.maxPage">#</s:if><s:else>salgrade-list?pageNum=${pageNum+1 }</s:else>"
												class="right-font08">下一页</a> | <a
												href="salgrade-list?pageNum=${maxPage }"
									...
									<input name="Submit" id="salgrade-input" type="button"
										class="btn btn-outline btn-success" value="添加薪资类型" />
								</form>
							</div>
						</div>
					</div>
