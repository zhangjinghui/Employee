			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">客户信息查看</div>
						<!-- /.panel-heading -->
						<div class="panel-body">

							<div class="table-responsive">
								<form action="customer-list" name="fom" id="fom" method="post">
										...
										<tbody>
											<s:iterator value="#request.customers">
												<tr>
													...
													<td>${phone }</td>
													<td>${address }</td>
													<td><s:if test="briefintroduction.length()>10">
															<s:property value='briefintroduction.substring(0,10)' />...
	 														</s:if> <s:else>
															<s:property value='briefintroduction' />
														</s:else></td>
													<td><s:date name="createtime"
															format="yyyy-MM-dd hh:mm:ss" /></td>
													<td><a href="customer-input?id=${id }">编辑</a>&nbsp;|&nbsp;<a
														class="delete" href="customer-delete?id=${id }">删除</a>&nbsp;|&nbsp;<a
														href="customer-get?id=${id }">查看</a></td>
												</tr>
											</s:iterator>
										</tbody>
									</table>
									...
									<table width="100%" border="0" align="center" cellpadding="0"
										...
										<tr>
											...
											<td width="49%" align="right">[<a
												href="customer-list?pageNum=1" class="right-font08">首页</a> |
												<a
												href="<s:if test="pageNum == 1">#</s:if><s:else>customer-list?pageNum=${pageNum-1 }</s:else>"
												class="right-font08">上一页</a> | <a
												href="<s:if test="pageNum == #request.maxPage">#</s:if><s:else>customer-list?pageNum=${pageNum+1 }</s:else>"
												class="right-font08">下一页</a> | <a
												href="customer-list?pageNum=${maxPage }"
									...
									<input name="Submit" id="customer-input" type="button"
											class="btn btn-outline btn-success" value="添加客户信息" />
								</form>
							</div>
						</div>
					</div>
