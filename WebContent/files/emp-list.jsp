					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="table-responsive">
								<form action="emp-list" name="fom" id="fom" method="post">
											...
											<s:iterator value="#request.employees">
												<tr>
													...
													<td><a href="emp-input?empno=${empno }">编辑</a>&nbsp;|&nbsp;<a
														...
														href="sal-input?empno=${empno}">发工资</a></td>
												</tr>
											</s:iterator>
										</tbody>
									</table>
									...
									<table width="100%" border="0" align="center" cellpadding="0"
										...
										<tr>
											...
											<td width="49%" align="right">[<a
												href="emp-list?pageNum=1" class="right-font08">首页</a> | <a
												href="<s:if test="pageNum == 1">#</s:if><s:else>emp-list?pageNum=${pageNum-1 }</s:else>"
												class="right-font08">上一页</a> | <a
												href="<s:if test="pageNum == #request.maxPage">#</s:if><s:else>emp-list?pageNum=${pageNum+1 }</s:else>"
												class="right-font08">下一页</a> | <a
												href="emp-list?pageNum=${maxPage }" class="right-font08">末页</a>]
												转至：
											</td>
											<td width="1%">
