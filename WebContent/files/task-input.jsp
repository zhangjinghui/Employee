			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">任务信息添加</div>
						<!-- /.panel-heading -->
						<div class="panel-body">
							<div class="row">

								<s:form action="task-save" method="post" theme="simple"
									role="form">
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<s:textfield name="createtime" class="form-control"
												required="true"></s:textfield>
											<span style="color: red">${fieldErrors.createtime }</span>
										</div>
										<div class="form-group">
											<label>计划开始时间</label>
											<s:textfield name="starttime" class="form-control"
												required="true"></s:textfield>
											<span style="color: red">${fieldErrors.starttime }</span>
										</div>

										<div class="form-group">
											<label>计划结束时间</label>
											<s:textfield name="endtime" class="form-control"
												required="true"></s:textfield>
											<span style="color: red">${fieldErrors.endtime }</span>
										</div>
										<div class="form-group">
											<label>优先级</label>
											<s:select name="priority"
												list="#{'急':'急','一般':'一般','很急':'很急' }" class="form-control"></s:select>
										</div>
										<div class="form-group">
											<label>任务执行部门</label>
									...
									<div class="row">
										<div class="col-lg-6">
											<s:hidden name="sender" value="%{#session.user.realname}" />
											<div class="form-group">
												<td nowrap align="right" height="120px">任务说明:</td>
												<td colspan="3"><s:textarea id="textarea"
														name="content" rows="5" cols="80"></s:textarea></td>
											</div>
