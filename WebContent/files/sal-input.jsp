			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">工资信息添加</div>
						<!-- /.panel-heading -->
						<div class="panel-body">
							<div class="row">

								<s:form action="sal-save" method="post" theme="simple"
									role="form">
									<div class="col-lg-6">
										<s:hidden name="ename"></s:hidden>
										<s:hidden name="job"></s:hidden>
										<s:hidden name="sender" value="%{#session.user.realname }"></s:hidden>
										<div class="form-group">
											<label>奖金</label>
											<s:textfield name="bouns" class="form-control"
												required="true"></s:textfield>
										</div>
										<div class="form-group">
											<label>年份</label>
											<s:select name="year" list="{2016,2017}"
														 required="true" class="form-control"></s:select>
										</div>
									</div>
									<div class="row">
										<div class="col-lg-6">
											<div class="form-group">
												<label>处罚扣除金额</label>
												<s:textfield name="fine" class="form-control"
													required="true"></s:textfield>
											</div>
											<div class="form-group">
												<label>月份</label>
