				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<s:if test="id == null">添加薪资类型</s:if>
							<s:else>编辑薪资类型</s:else>
						</div>
						<!-- /.panel-heading -->
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-6">
									<s:form action="salgrade-save" method="post" theme="simple"
										role="form">
										<s:hidden name="id"></s:hidden>
										<div class="form-group">
											<label>职位</label>
											<s:textfield name="job" class="form-control" required="true"></s:textfield>
										</div>
								</div>
								<div class="row">
									<div class="col-lg-6">
										<div class="form-group">
											<label>基本工资</label>
											<s:textfield name="basicsalary" class="form-control"
													required="true"></s:textfield><span style="color:red">${fieldErrors.basicsalary[0] }</span>
										</div>
