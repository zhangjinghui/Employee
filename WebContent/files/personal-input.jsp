									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<s:password name="password" label="password"
												showPassword="true" required="true" class="form-control"></s:password>
										</div>
										<div class="form-group">
											<label>真实姓名</label>
											<s:textfield name="realname" label="realname" disabled="true"
												class="form-control"></s:textfield>
										</div>
										<div class="form-group">
											<label>性别</label>
											<s:radio name="sex" label="sex" list="{'男','女'}"
										...
										<div class="col-lg-6">
											<div class="form-group">
												...
												<s:textfield name="age" label="age" required="true"
													class="form-control"></s:textfield>
												<span style="color: red">${fieldErrors.age[0] }</span>
											</div>
											<div class="form-group">
												<label>邮箱</label>
												<s:textfield name="email" label="email" required="true"
													class="form-control"></s:textfield>
												<span style="color: red">${fieldErrors.email[0] }</span>
											</div>
											<div class="form-group">
												<label>电话</label>
												<s:textfield name="phone" label="phone" required="true"
													class="form-control"></s:textfield>
